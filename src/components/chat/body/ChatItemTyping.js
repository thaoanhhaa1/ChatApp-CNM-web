        ...
        <div>
            <div className="max-w-[75%] flex">
                ...
                <div className="ml-2 sm:ml-4 mr-1">
                    <div className="flex flex-col gap-1 px-2 dl:px-5 py-1 dl:py-3 rounded-t-lg rounded-r-lg bg-primary-color">
                        <Typing isChat />
                    </div>
                    <div className="border-5 w-0 border-primary-color border-r-transparent border-b-transparent" />
